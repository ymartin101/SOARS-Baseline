/// rsworld.h - The simulator world contains all the other objects in the simulator's worldview
...
namespace rs {
    ...
    class World {
        public:
            ...
            // When Add is called with an object's pointer, the World takes control over that objects resources and will delete the object when necessary
            ...
            friend void RunThreadedSim(World *world, int MaxThreads, int MaxBlocks, int thread_limit);
            friend void SimulatePair(Transmitter *trans, Receiver *recv, World *world, int MaxThreads, int MaxBlocks);

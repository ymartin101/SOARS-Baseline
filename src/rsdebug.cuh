...
namespace rsDebug {
    ...
    enum Level
    {
        RS_VERY_VERBOSE, // Messages which are only useful for debugging
    ...
    // Print a formatted debug message at the current level (uses C printf function, with all the format specifiers supported)

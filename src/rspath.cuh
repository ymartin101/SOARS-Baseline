/// rspath.h - Structures and Classes for Paths and Coordinates
...
namespace rs {
    ...
    /// Support arithmetic on path coordinates
    ...
    /// Azimuth-Elevation rotation position and time; note that the plane for azimuth is the x-y plane (see Coord)
